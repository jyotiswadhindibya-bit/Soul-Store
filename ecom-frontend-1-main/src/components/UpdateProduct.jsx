...
const UpdateProduct = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    const submitProduct = {
      ...updateProduct,
      price: updateProduct.price ? Number(updateProduct.price) : 0,
      quantity: updateProduct.quantity ? Number(updateProduct.quantity) : 0
    };
    ...
    formData.append(
      "product",
      new Blob([JSON.stringify(submitProduct)], { type: "application/json" })
    );
        ...
        <form className="row g-3 pt-5" onSubmit={handleSubmit}>
          ...
          <div className="col-12">
            ...
            <input
              type="text"
              className="form-control"
              placeholder={updateProduct.desc}
              name="desc"
              onChange={handleChange}
          ...
          <div className="col-12">
            <div className="form-check">
              <input
                ...
                name="avail"
                id="gridCheck"
                checked={updateProduct.avail}
                onChange={(e) =>
                  setUpdateProduct({ ...updateProduct, avail: e.target.checked })
                }
              />
